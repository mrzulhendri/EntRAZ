...
export async function GET(request) {
    try {
        ...
        // Fix: In Postgres, when using DISTINCT, the expressions in ORDER BY must appear in SELECT list.
        // We wrap the query to allow ordering by any column.
        const dataQuery = `
            SELECT * FROM (
            ...
            ORDER BY ${orderClause.replace('c.', 'sub.')}
        ...
        // Memberikan detail error di response untuk mempermudah debugging
        return NextResponse.json({
